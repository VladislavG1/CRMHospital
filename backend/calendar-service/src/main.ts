...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    .setTitle('CalendarMicroService')
    .setDescription('Микросервис управления расписанием. Включает управление рабочими сменами отделений, логикой записи пациентов и синхронизацию с задачами.')
    .setVersion('1.0')
    .addBearerAuth(
